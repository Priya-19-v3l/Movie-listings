...
class movie_listing:
    ...
    def choice(self):
        ...
        if(sel_choice==1):
            m1=movie_listing(1,'Don','Tamil','10:10 am',2,'19.07.2023')
            m2=movie_listing(2,'Prince','Tamil','10:00 am',2.30,'26.07.2023')
            m3=movie_listing(3,'Lio','Tamil','12:10 am',2.15,'20.07.2023')
            print("Available Tamil Movie's are: ")
            print(m1.movie_name)
            print(m2.movie_name)
            print(m3.movie_name)
        elif(sel_choice==2):
            m1=movie_listing(1,'Premam','Malayalam','10:10 am',2,'8.07.2023')
            m2=movie_listing(2,'Hridayam','Malayalam','10:00 am',2.30,'26.07.2023')
            m3=movie_listing(3,'Jana Gana Mana','Malayalam','12:10 am',2.15,'20.07.2023')
            print("Available Tamil Movie's are: ")
            print(m1.movie_name)
            print(m2.movie_name)
            print(m3.movie_name)
...
if __name__=="__main__":
    l1=login(1,'priya','priya@gmail.com','8072649175','Female','Priya*2003')
    #l2=login(2,'Banupriya','banupriya@gmail.com','9072649175','Female','Saran45')
    #l3=login(3,'Guru','guru@gmail.com','8090609175','Male','Ply79')
    l1.check('Priya*2003','priya@gmail.com')
